...
def create_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS employee(eid INTEGER PRIMARY KEY AUTOINCREMENT,f_name text,l_name text,contact text,question text,answer text,password text)")
    con.commit()
    con.close()
create_db()
